...
REM
REM Generated by Vivado on Wed May 11 02:39:41 -0400 2022
...
echo "xvlog --incr --relax -prj tb_FIR_vlog.prj"
call xvlog  --incr --relax -prj tb_FIR_vlog.prj -log xvlog.log
